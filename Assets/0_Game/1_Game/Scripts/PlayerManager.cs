...
public class PlayerManager : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0) && MenuManager1.MenuManagerInstance.GameState)
        {
            moveTheBall = true;
            BallTrail.Play();
        ...
        if (MenuManager1.MenuManagerInstance.GameState)
        {
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("obstacle"))
        {
            ...
            MenuManager1.MenuManagerInstance.GameState = false;
            MenuManager1.MenuManagerInstance.menuElement[2].SetActive(true);
            MenuManager1.MenuManagerInstance.menuElement[2].transform.GetChild(0).GetComponent<Text>().text = "You Lose";
        ...
        if (other.gameObject.name.Contains("Colorball"))
        {
            ...
            MenuManager1.MenuManagerInstance.menuElement[1].GetComponent<Text>().text = PlayerPrefs.GetInt("score").ToString();
        }
